...
namespace Digi2
{
    public static class LogTN // v1.4
    {
        ...
        {
            LogTN.modName = modName;
            LogTN.modFolder = (modFolder == null ? modName : modFolder);
            LogTN.workshopId = workshopId;
        }
        ...
        public static void Init()
        {
            ...
            writer = MyAPIGateway.Utilities.WriteFileInLocalStorage(LOG_FILE, typeof(LogTN));
