        ...
        public override void LoadData()
        {
            ...
            foreach (var def in allPlanets)
            {
                ...
                for (int i = 0; i < oreList.Count; i++) {
                    ...
                    if (oreMap.Type.Contains("Ice_01") == true) { oreMap.Start = 0; oreMap.Depth = 20; }

                    if (oreMap.Type.Contains("Iron_02") == true) { oreMap.Start = 0; oreMap.Depth = 25; }
                    if (oreMap.Type.Contains("Nickel_01") == true) { oreMap.Start = 0; oreMap.Depth = 15; }
                    if (oreMap.Type.Contains("Silicon_01") == true) { oreMap.Start = 0; oreMap.Depth = 20; }

                    if (oreMap.Type.Contains("Cobalt_01") == true) { oreMap.Start = 0; oreMap.Depth = 15; }
                    if (oreMap.Type.Contains("Magnesium_01") == true) { oreMap.Start = 0; oreMap.Depth = 15; }
